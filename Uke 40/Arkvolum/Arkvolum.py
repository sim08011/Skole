...
# Algoritme for hvordan man kan brette et a4-ark for å få størst volum.

arkL = 297 # Definere variabel for a4 lengde i millimeter
arkB = 210 # Definere variabel for a4 bredde i millimeter

hoyde = 0 # Definere variabel for starthøyde i millimeter


# Definere en funksjon som kjører algoritmen
def algoritme(hoyde):
     ...
     while storsteVolum == gjeldendeVolum:
          ...
          nyArkB = arkB-(hoyde*2) # Definere en variabel som lagrer den nye bredden til arket med tanke på at høyden tar litt av sidene
